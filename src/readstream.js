...
export function GridReadStream(grid, options) {
    ...
    //TODO conflicts with function parameter
    var options = {};
    ...
    /*
      this._store = new grid.mongo.GridStore(
      this._store = new grid.mongo.GridFSBucket(
          grid.db,
    ...
    options.bucketName = this.name;
    this._store = new MongoInternals.NpmModule.GridFSBucket(
        MongoInternals.defaultRemoteCollectionDriver().mongo.db,
        {bucketName: options.root});
...
GridReadStream.prototype._open = function _open() {
    var self = this;
    this._opening = true;
    //I don't think we need to explicitely open in the new API so bypass.
