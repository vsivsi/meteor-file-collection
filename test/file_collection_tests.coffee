...
if Meteor.isServer
  ...
  Tinytest.addAsync 'MongoDB ObjectID Sanity Checks', (test, onComplete) ->
    _id = testColl.insert({})
    hex = _id.toHexString()
    meteorObjID = new Mongo.ObjectID hex
    mongoObjID = mongodb.ObjectID hex
    altmongoObjID = NpmModuleMongodb.ObjectID hex
    test.instanceOf meteorObjID, Mongo.ObjectID
    test.instanceOf mongoObjID, mongodb.ObjectID
    test.instanceOf altmongoObjID, NpmModuleMongodb.ObjectID
    test.ok mongodb.ObjectID.isValid hex
    test.ok mongodb.ObjectID.isValid mongoObjID
    test.notEqual hex, meteorObjID
    test.notEqual hex, mongoObjID
    test.notEqual mongoObjID, meteorObjID
    # test.equal altmongoObjID.toHexString(), meteorObjID.toHexString()
    test.equal mongoObjID.toHexString(), meteorObjID.toHexString()
    test.equal meteorObjID.toString(), "ObjectID(\"#{mongoObjID.toString()}\")"
    test.equal new Mongo.ObjectID(mongoObjID.toHexString()), meteorObjID
    test.equal mongoObjID, mongodb.ObjectID(meteorObjID.toHexString())
    test.equal hex, "#{meteorObjID}"
    test.equal hex, "#{mongoObjID}"
    test.equal hex, meteorObjID.toHexString()
    test.equal hex, mongoObjID.toHexString()
    doc = testColl.findOne {_id: meteorObjID}
    test.equal doc._id, _id
  ...
  #         test.equal _id, file._id
  #         test.equal mongodb.ObjectID(file._id.toHexString()), new Mongo.ObjectID file._id.toHexString()
  #         test.equal mongodb.ObjectID("#{file._id}"), new Mongo.ObjectID "#{file._id}"
  #         test.equal mongodb.ObjectID("#{_id}"), new Mongo.ObjectID "#{_id}"
  #         test.equal 0, 1
  #         console.dir _id
  #         console.dir file._id
  #         # console.dir new Mongo.ObjectID _id
  #         # console.dir new Mongo.ObjectID file._id
  #         console.dir new Mongo.ObjectID file._id.toHexString()
  #         console.dir mongodb.ObjectID(file._id.toHexString())
  #         console.warn "4)"
  #         # readstream = testColl.findOneStream {_id: file._id }
  #         readstream = testColl.findOneStream {_id: _id}
  #         console.warn "5)"
